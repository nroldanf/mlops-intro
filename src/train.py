from utils import update_model, save_simple_metrics_report, get_model_performance
...
logger.info("Separating dataset in train and test...")
...
logger.info("Crossvalidating with best model...")
